...
export function AmbientBackdrop() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute -top-[22%] -left-[12%] h-[62vw] w-[62vw] rounded-full bg-[radial-gradient(circle,rgba(101,80,200,0.26)_0%,transparent_62%)] blur-[40px]"
        animate={reduceMotion ? undefined : { x: [0, 60, 0], y: [0, 42, 0] }}
        transition={{ duration: 46, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute -right-[16%] bottom-[-26%] h-[58vw] w-[58vw] rounded-full bg-[radial-gradient(circle,rgba(196,86,52,0.16)_0%,transparent_64%)] blur-[50px]"
