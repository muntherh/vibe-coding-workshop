            ...
            >
              ...
              <div
                className={cn(
                  ...
                  isVisible ? "border-vibe-violet/30" : "border-line/60",
                  isCurrent && "border-vibe-coral/50",
                )}
              >
                <span
                  className={cn(
                    ...
                    isVisible
                      ? "border-vibe-violet/45 bg-vibe-violet/12 text-vibe-violet"
                ...
                <code
                  className={cn(
                    ...
                    isVisible
                      ? "border-line bg-navy-950/70 text-vibe-violet-bright"
