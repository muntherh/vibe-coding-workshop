  ...
  return (
    <DeckContext.Provider value={deckValue}>
      ...
      <a
        ...
        className="sr-only-focusable focus:not-sr-only focus:fixed focus:top-4 focus:start-4 focus:z-[80] focus:h-auto focus:w-auto focus:rounded-lg focus:bg-accent-warm focus:px-4 focus:py-2 focus:text-[#2a1206] focus:[clip-path:none]"
      >
        Skip to the lesson
      </a>
